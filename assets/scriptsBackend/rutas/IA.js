...
// Módulo compartido — lógica de próximo partido (también usada por Elite.js)
...
// ============================================================
// 3. GENERACIÓN AUTOMÁTICA DEL INFORME OFICIAL
// Fecha y jornada obtenidas en tiempo real desde football-data.org
// ============================================================
router.get('/informe-oficial', verificarToken, async (req, res) => {
  ...
  res.json({
    ...
    jornada: `Próximo partido (${partido.jornada})`,
    fecha:   partido.fecha,
    parametros: {
